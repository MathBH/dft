/*
	Struct used for DFT algorithm taken from https://github.com/lzhbrian/Fast-Fourier-Transform.git
	This DFT is used for testing results of this project's FFT algorithms.
